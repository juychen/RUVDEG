#!/usr/bin/env bash
# Run the distance benchmark on batch-pair-loss scVI h5ad files.
set -euo pipefail

SCRIPT="${SCRIPT:-/home/junyichen/code/RUVAEDEG/benchmarkbyauc_DM.py}"
INPUT_DIRS=(${INPUT_DIRS:-/data3/junyi/six_datasets_4v3_500_1000gene_batchmod})
NORMALIZED_LAYER="${NORMALIZED_LAYER:-batchpair_D1_normlized}"
COUNT_LAYER="${COUNT_LAYER:-batchpair_D1_counts}"
...
export -f run_one
export SCRIPT NORMALIZED_LAYER COUNT_LAYER CELLTYPE_KEY BATCH_KEY GENE_LIST OUT_ROOT MODEL HARD_CODED_H
